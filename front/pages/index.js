          ...
          >
                ...
                <Container className='d-flex align-items-center container-landing add-space'>
                    <div className="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
                        <h1 className="text-primary">Introducing Kanbana</h1>
                        <p className="text-dark">Our platform uses AI to automate task management for team projects, assigning tasks based on individual skills and knowledge. Boost productivity and efficiency with intelligent task allocation.</p>
